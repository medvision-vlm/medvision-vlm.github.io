...
(function () {
  ...
  var MODEL_ORDER = {
    Detection: ["MedVision-V0 (7B)", "Gemma-4 (31B)", "Lingshu (32B)",
      "Qwen3-VL-Thinking (32B)", "MedGemma (27B)", "MedGemma (4B)", "Qwen2.5-VL (32B)",
      "LLaVA-OneVision (72B)", "MiniMax-M3 (428B, int4)", "InternVL3 (38B)", "Qwen2.5-VL (7B)",
      "GLM-4.6V-Flash (9B)", "Gemma-3 (27B)", "HealthGPT (14B)", "MedDr (40B)",
      "HuatuoGPT-Vision (34B)", "GLM-4.6V (106B)", "Llama-3.2-Vision (11B)"],
    TL: ["MedVision-V0 (7B)", "Gemma-4 (31B)", "MiniMax-M3 (428B, int4)", "GLM-4.6V (106B)",
      "GLM-4.6V-Flash (9B)", "Lingshu (32B)", "Qwen3-VL-Thinking (32B)", "HealthGPT (14B)",
      "Gemma-3 (27B)", "LLaVA-OneVision (72B)", "Qwen2.5-VL (7B)", "InternVL3 (38B)",
      "MedGemma (4B)", "HuatuoGPT-Vision (34B)", "MedDr (40B)", "Llama-3.2-Vision (11B)",
      "MedGemma (27B)", "Qwen2.5-VL (32B)"],
    AD: ["MedVision-V0 (7B)", "GLM-4.6V-Flash (9B)", "Gemma-4 (31B)", "Qwen3-VL-Thinking (32B)",
      "HealthGPT (14B)", "Lingshu (32B)", "MedDr (40B)", "LLaVA-OneVision (72B)",
      "Gemma-3 (27B)", "MedGemma (4B)", "InternVL3 (38B)", "Qwen2.5-VL (7B)", "GLM-4.6V (106B)",
      "MiniMax-M3 (428B, int4)", "MedGemma (27B)", "Qwen2.5-VL (32B)", "HuatuoGPT-Vision (34B)",
  ...
  CaseViewer.prototype.build = function () {
    ...
    for (var m = 0; m < this.modelKeys.length; m++) {
      ...
      if (/^claude/i.test(this.modelKeys[m])) {
        mb.innerHTML = ANTHROPIC_ICON + this.modelKeys[m];
      } else if (/^gemini/i.test(this.modelKeys[m])) {
        mb.innerHTML = GEMINI_ICON + this.modelKeys[m];
      } else {
        mb.textContent = this.modelKeys[m];
      }
